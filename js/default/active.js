(function() {
    ...
    var sideNavFilter = $("#sidenavFilter");
    ...
    //filter//
    $("#suhaNavbarFilter").on("click", function() {
        sideNavFilter.addClass("nav-active");
        blackOverlay.addClass("active");
    });
    $("#goHomeBtn").on("click", function() {
        sideNavFilter.removeClass("nav-active");
        blackOverlay.removeClass("active");
    });
    blackOverlay.on("click", function() {
            $(this).removeClass("active");
